...
const EMPTY_TAG_LIST: NonNullable<Article['tagList']> = [];
...
function ArticleCard({
  ...
  return (
    <Card
      className={cn(
        'group border-border bg-card/50 hover:border-primary/20 w-full cursor-pointer gap-0 overflow-hidden border p-0 shadow-none transition-all duration-300',
        className,
      )}
      {...rest}
    >
