...
function Header() {
  return (
    <header className="bg-background/95 supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50 w-full border-b-1 border-dashed backdrop-blur">
      <div className="container-padding container mx-auto flex h-14 items-center justify-between gap-2 border-x-1 border-dashed md:gap-4">
